  ...
  L.M.S
        ...
        <div className="side-navbar-content">
          ...
          <Link
            ...
            onMouseLeave={() => setHoveredLink(null)}
          >
            <i className="fas fa-user" style={{ color: 'blue' }}></i> Profile
          </Link>
          <Link
            to="/attendance"
          ...
          <Link
            ...
            onMouseEnter={() => setHoveredLink('/timetable')}
            onMouseLeave={() => setHoveredLink(null)}
          >
          ...
          <Link
            to="/signin"
            style={getLinkStyle('/accounts')}
            onMouseEnter={() => setHoveredLink('/accounts')}
            onMouseLeave={() => setHoveredLink(null)}
